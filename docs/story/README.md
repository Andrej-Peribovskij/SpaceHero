...
Purpose: the canonical setting, history, characters, and tone of SpaceHero.
Game content — scenes, dialogue, encounters, seed data — is held to this
document. A change that contradicts it updates the bible in the same change.

Chapter outlines live beside it: [Chapter 1](chapter-01.md).
...
- **Danny Mellow**, a high agent of the Absolute Connections zaibatsu, is
  infected by an alien parasite and is using the company to send Joe on a
  suicide mission.
- Tone: a serious world, full of absurd people.

Items marked *(proposal)* are suggestions not yet confirmed. Everything else is
canon.
...
**Mars.** Warmer since the Brightening, but still thin-aired and without a
...
It has been compromised from within: see Danny Mellow.
...
the first hint of the alien invasion.

**The invaders.** Alien invaders from outer space. They arrive in later
chapters, forcing a humble courier to pick up weapons. Their vanguard is
already here: an alien parasite that infects humans and uses them from the
inside.
...
- Space courier. Very young.
- The best pilot in the solar system.
- His lazy attitude has kept him on little jobs only, so almost nobody knows
  how good he is.
- At the start of the game he has been spending his time lazily on the surface
  of Mars, waiting for his new job to begin.
- He is the only one who can beat the invaders. This is why he is the target,
  though he does not know it.
- His ship is the **Phaselus**. *(proposal)* The name is Latin for a light, fast
  boat — and the boat in Catullus's poem that boasts it was the swiftest ever
  built. A fitting ship for the best pilot, and for a slightly vain one.
- *(proposal)* His surname invites jokes: strangers ask if he is feeling well,
  and in misremembered Old Earth slang, "sick" meant "excellent".
- *(proposal)* Gameplay: at the controls — the shooter and piloting sections —
  Joe is brilliant. In adventure scenes his laziness is a mechanic: the
  low-effort option is sometimes the funniest, occasionally the smartest.
- Arc: from lazy courier to reluctant hero.

### Danny Mellow

- High agent working for the Absolute Connections zaibatsu.
- Infected by an alien parasite.
- Uses his power in the company to enrol Joe in a suicide mission.
- *(proposal)* His surname is the joke and the tell: a man called Mellow who is
  never quite relaxed, whose calm is a little too perfect.

## Open Questions

- **What makes Joe the only one** who can beat the invaders — his piloting
  alone, or something more? And how do the invaders know?
- **The pursuers and Danny:** if Danny is sending Joe on a suicide mission, who
