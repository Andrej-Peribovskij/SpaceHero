---
description: Fold staging components into the shipped design system and republish (design technologist)
...
Follow the process defined in @process/design/prompts/05-promote-ds-staging.md
