---
description: Delete explicitly named, superseded design versions — manual trigger only (design technologist)
...
Follow the process defined in @process/design/prompts/07-clean-design-versions.md
