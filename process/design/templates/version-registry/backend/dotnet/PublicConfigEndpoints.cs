...
// (templates/version-registry/backend/dotnet). Copy into your API and change the namespace.
//
// Register it in Program.cs beside the health endpoints:
...
using __API_NAMESPACE__.Configuration;

namespace __API_NAMESPACE__.Endpoints;
